            ...
            <div class="col-xl-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h1 class="mb-3">h1. Bootstrap heading <small class="text-muted">2.03125rem (32.5px)</small>
                        </h1>

                        <h2 class="mb-3">h2. Bootstrap heading <small class="text-muted">1.625rem (26px)</small></h2>

                        <h3 class="mb-3">h3. Bootstrap heading <small class="text-muted">1.42188rem (22.75px)</small>
                        </h3>

                        <h4 class="mb-3">h4. Bootstrap heading <small class="text-muted">1.21875rem (19.5px)</small>
                        </h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Remove the default <code class="highlighter-rouge">list-style</code>
            ...
            <div class="col-xl-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">For quoting blocks of content from another source within your
                            document. Wrap <code class="highlighter-rouge">&lt;blockquote
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Remove a list’s bullets and apply some light <code
                                class="highlighter-rouge">margin</code> with a combination of two classes, <code
                                class="highlighter-rouge">.list-inline</code> and
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Align terms and descriptions horizontally by using our grid system’s
                            predefined classes (or semantic mixins). For longer terms, you can optionally add a <code
                                class="highlighter-rouge">.text-truncate</code> class to truncate the text with an
                            ellipsis.</p>
