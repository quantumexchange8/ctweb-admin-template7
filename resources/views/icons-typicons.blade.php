                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row icon-demo-content">
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-media-fast-forward-outline"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-media-play-reverse-outline"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-point-of-interest-outline"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-social-dribbble-circular"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-social-facebook-circular"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-social-google-plus-circular"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-social-instagram-circular"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-social-linkedin-circular"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-social-pinterest-circular"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-sort-alphabetically-outline"></i> typcn
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <i class="typcn typcn-sort-numerically-outline"></i> typcn
