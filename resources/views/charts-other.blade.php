                    ...
                    <div class="card-body">
                        ...
                        <div class="row text-center">
                            <div class="col-xl-4 col-sm-6 text-center" dir="ltr">
                                ...
                                <input class="knob" data-width="150" data-fgcolor="#7a6fbe" data-displayinput="false"
                                    value="35">
                            </div>
                            <div class="col-xl-4 col-sm-6 text-center" dir="ltr">
                                <h5 class="font-size-16 mb-4">Cursor mode</h5>
                                <input class="knob" data-width="150" data-cursor="true" data-fgcolor="#4ac18e"
                                    value="29">
                            </div>
                            <div class="col-xl-4 col-sm-6 text-center" dir="ltr">
                            ...
                            <div class="col-xl-4 col-sm-6 text-center" dir="ltr">
                                ...
                                <input class="knob" data-width="150" data-min="-15000" data-displayprevious="true"
                                    data-max="15000" data-step="1000" value="-11000" data-fgcolor="#1d1e3a">
                            </div>
                            <div class="col-xl-4 col-sm-6 text-center" dir="ltr">
                                <h5 class="font-size-16 mb-4">Angle offset and arc</h5>
                                <input class="knob" data-width="150" data-cursor="true" data-fgcolor="#f06292"
                                    value="29">
                            </div>
                            ...
                            <div class="col-xl-4 col-sm-6 text-center" dir="ltr">
                                ...
                                <input class="knob" data-width="150" data-height="150" data-displayPrevious=true
                                    ...
                                    data-thickness=".2" data-angleOffset=-125 data-angleArc=250 />
