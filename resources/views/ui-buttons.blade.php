            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">The <code class="highlighter-rouge">.btn</code> classes are designed
                            to be used with the <code class="highlighter-rouge">&lt;button&gt;</code> element. However,
                            you can also use these classes on <code class="highlighter-rouge">&lt;a&gt;</code> or <code
                                class="highlighter-rouge">&lt;input&gt;</code> elements (though some browsers may apply
                            a slightly different rendering).</p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2 align-items-center">
                            ...
                            <button type="button" class="btn btn-info btn-sm waves-effect waves-light">Small
                                button</button>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Add <code class="highlighter-rouge">data-toggle="button"</code> to
                            toggle a button’s <code class="highlighter-rouge">active</code> state. If you’re
                            pre-toggling a button, you must manually add the <code
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="button"
                                aria-pressed="false">
                                Single toggle
                            </button>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Bootstrap’s <code class="highlighter-rouge">.button</code> styles can
                            be applied to other elements, such as <code class="highlighter-rouge">
                                                &lt;label&gt;</code>s, to provide checkbox or radio style button toggling.
                            Add <code class="highlighter-rouge">data-toggle="buttons"</code> to a
                            <code class="highlighter-rouge">.btn-group</code> containing those modified buttons to
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Combine sets of button groups into button toolbars for more complex
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Instead of applying button sizing classes to every button in a group,
                            just add <code class="highlighter-rouge">.btn-group-*</code> to each <code
                                class="highlighter-rouge">.btn-group</code>, including each one when nesting multiple
                            groups.</p>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Make a set of buttons appear vertically stacked rather than
                            horizontally. Split button dropdowns are not supported here.</p>
