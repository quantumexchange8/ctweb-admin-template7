...
<head>
    ...
    <meta charset="utf-8" />
    <title>Horizontal Layout | Current Tech | Admin Templete</title>
                        ...
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="morris-donut-example" data-colors='["#f0f1f4","--bs-primary","--bs-info"]' class="morris-charts morris-charts-height" dir="ltr">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="morris-area-example" data-colors='["#f0f1f4","--bs-primary","--bs-info"]' class="morris-charts morris-charts-height" dir="ltr">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="morris-bar-stacked"  data-colors='["--bs-info","#f0f1f4"]'  class="morris-charts morris-charts-height" dir="ltr">
                                    </div>
                                </div>
                            </div>
                        </div>
